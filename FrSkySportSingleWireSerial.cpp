/*
  FrSky single wire serial class for Teensy 3.x/4.0/LC, ESP8266 and ATmega328P based boards (e.g. Pro Mini, Nano, Uno)
  (c) Pawelsky 20191103
...
#else
  #error "Unsupported processor! Only Teesny 3.x/4.0/LC, ESP8266 and ATmega328P based boards supported.";
#endif
  crc = 0;
  setMode(RX);
}
